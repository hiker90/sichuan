...
public class SystemLogAspect {
    ...
    //Service层切点
    @Pointcut("@annotation(com.zzsj.analysis.manage.service.SysServiceLog)")
    public void serviceAspect() {
    }

    //Controller层切点
    @Pointcut("@annotation(com.zzsj.analysis.manage.controller.SysControllerLog)")
