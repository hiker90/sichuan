package com.zzsj.analysis.base.constants;
...
public class UserConstants
{
    ...
    /** 部门名称是否唯一的返回结果码 */
    public final static String DEPT_FULLNAME_UNIQUE = "0";
    public final static String DEPT_FULLNAME_NOT_UNIQUE = "1";
    ...
    /** 目录名称是否唯一的返回结果码 */
    public final static String DIRECTORY_NAME_UNIQUE = "0";
    public final static String DIRECTORY_NAME_NOT_UNIQUE = "1";
}
