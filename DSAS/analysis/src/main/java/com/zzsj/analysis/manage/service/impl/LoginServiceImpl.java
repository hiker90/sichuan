...
import com.zzsj.analysis.base.constants.ShiroConstants;
import com.zzsj.analysis.base.constants.UserConstants;
import com.zzsj.analysis.base.exception.BusinessException;
import com.zzsj.analysis.base.pojo.vo.SysUser;
import com.zzsj.analysis.base.utils.ServletUtils;
import com.zzsj.analysis.base.utils.enums.UserStatus;
import com.zzsj.analysis.manage.mapper.mysql.UserMapper;
import com.zzsj.analysis.manage.service.LoginService;
    ...
    public SysUser login(String username) throws Exception
    {
        ...
        if (StringUtils.isEmpty(username))
        {
         //   AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, Constants.LOGIN_FAIL, MessageUtils.message("not.null")));
            throw new BusinessException("户名或密码为空 错误");
        }
                ...
                || username.length() > UserConstants.USERNAME_MAX_LENGTH)
        {
         //   AsyncManager.me().execute(AsyncFactory.recordLogininfor(username, Constants.LOGIN_FAIL, MessageUtils.message("user.password.not.match")));
            throw new BusinessException("用户名不在指定范围内 错误");
        }
