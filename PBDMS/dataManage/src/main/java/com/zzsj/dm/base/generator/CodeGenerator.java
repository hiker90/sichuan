package com.zzsj.dm.base.generator;
...
public class CodeGenerator {
     ...
     * 数据库 URL
     */
    private static final String URL = "jdbc:oracle:thin:@//10.25.171.24:1521/ORCLPDB1";
    /**
     * 数据库驱动
     */
     ...
     *  数据库用户名
     */
    private static final String USERNAME = "sctsp";
    /**
     * 数据库密码
     */
    private static final String PASSWORD = "JdYS_3s97B";
    /**
     * @author 值
     */
     ...
     * 包的基础路径
     */
    private static final String BASE_PACKAGE_URL = "com.zzsj.dm";
    /**
     * xml文件路径
     */
